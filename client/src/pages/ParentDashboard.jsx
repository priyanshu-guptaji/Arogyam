...
import { patientAPI, alertAPI, healthAPI } from '../utils/api';
import { HealthCard, HealthCardSkeleton, AlertPanel, TrendChart, HistoryTable, EmergencyButton } from '../components/dashboard';
...
export function ParentDashboard() {
  ...
  const handleEmergency = async (patientId, notes) => {
    setSendingEmergency(true);
    try {
      await alertAPI.sendEmergency(patientId, notes);
    } catch (err) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-rose-50 to-red-50/50 border border-rose-200 rounded-2xl p-6">
        <EmergencyButton
          patients={patients}
